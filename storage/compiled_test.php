<?php $__env->startSection('title', 'Matriz de Apoyo Operativo'); ?>

<?php $__env->startSection('content'); ?>
<div id="mis-clientes-data" data-clientes='<?php echo json_encode($misClientes, 15, 512) ?>' class="hidden"></div>
    ...
    <div class="max-w-[1400px] mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                <div>
                    <div class="flex items-center gap-2 text-sm text-slate-500 mb-1">
                        ...
                        <span>/</span>
                        <span class="text-slate-700 font-medium">Matriz de Apoyo Operativo</span>
                    </div>
                    <h1 class="text-2xl font-bold text-slate-900">Matriz de Apoyo Operativo</h1>
                ...
                <div class="flex items-center gap-2">
                    ...
                    <select id="filtro-cliente-global" onchange="filtrarTodo()"
                        ...
                        <?php $__currentLoopData = $clientes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e(mb_strtolower($cl)); ?>"><?php echo e($cl); ?></option>
        ...
        <div class="flex gap-1 pt-2">
            ...
            <?php $__currentLoopData = $tabs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tab): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php $tabKey = $tab['key']; ?>
                <button onclick="cambiarTab(this.dataset.tab)" data-tab="<?php echo e($tabKey); ?>" id="tab-<?php echo e($tabKey); ?>"
            ...
            <div class="bg-white rounded-b-2xl rounded-tr-2xl border border-slate-200 shadow-sm overflow-hidden">
                ...
                <div class="px-5 py-4 border-b border-slate-100 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
                    <div>
                        ...
                        <p class="text-xs text-slate-400 mt-0.5"><?php echo e($agentes->count()); ?> registros</p>
                    </div>
                    ...
                    <table class="w-full text-sm border-collapse" id="tabla-agentes">
                        ...
                        <tbody id="tbody-agentes">
                            <?php
                                ...
                                $groupIndex = 0;
                            ?>
                            <?php $__empty_1 = true; $__currentLoopData = $grouped; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $groupKey => $rows): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <?php $bgClass = $groupIndex % 2 === 0 ? 'bg-white' : 'bg-slate-50/60'; ?>
                                <?php $__currentLoopData = $rows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="<?php echo e($bgClass); ?> border-b border-slate-100 hover:bg-amber-50/40 transition-colors group-row"
                                        data-grupo="<?php echo e($groupIndex); ?>"
                                        data-cliente="<?php echo e(mb_strtolower($row->cliente ?? '')); ?>"
                                        data-propio="<?php echo e(in_array(mb_strtolower($row->cliente ?? ''), $misClientes) ? '1' : '0'); ?>"
                                        data-search="<?php echo e(mb_strtolower($row->cliente . ' ' . $row->aduana . ' ' . $row->agente_aduanal . ' ' . $row->razon_social . ' ' . $row->patente . ' ' . $row->responsabilidad . ' ' . $row->nombre . ' ' . $row->correo_electronico . ' ' . $row->telefono . ' ' . $row->comentarios)); ?>">

                                        <?php if($i === 0): ?>
                                            <td rowspan="<?php echo e($rows->count()); ?>" class="px-4 py-3 font-semibold text-slate-800 align-top border-r border-slate-100 border-b border-slate-200">
                                                <?php echo e($row->cliente); ?>

                                            </td>
                                            <td rowspan="<?php echo e($rows->count()); ?>" class="px-4 py-3 text-slate-600 align-top border-r border-slate-100 border-b border-slate-200">
                                                <?php echo e($row->aduana); ?>

                                            </td>
                                            <td rowspan="<?php echo e($rows->count()); ?>" class="px-4 py-3 font-semibold text-slate-800 align-top border-r border-slate-100 border-b border-slate-200">
                                                <?php echo e($row->agente_aduanal); ?>

                                            </td>
                                            <td rowspan="<?php echo e($rows->count()); ?>" class="px-4 py-3 text-slate-600 align-top border-r border-slate-100 border-b border-slate-200">
                                                <?php echo e($row->razon_social); ?>

                                            </td>
                                            <td rowspan="<?php echo e($rows->count()); ?>" class="px-4 py-3 text-slate-600 align-top border-r border-slate-100 border-b border-slate-200 font-mono text-xs">
                                                <?php echo e($row->patente); ?>

                                            </td>
                                            <td rowspan="<?php echo e($rows->count()); ?>" class="px-4 py-3 align-top border-r border-slate-100 border-b border-slate-200 text-center">
                                                <?php if($row->calificacion): ?>
                                                    <div class="flex justify-center gap-0.5 mb-0.5">
                                                        <?php for($s = 1; $s <= 5; $s++): ?>
                                                            <span class="<?php echo e($s <= $row->calificacion ? 'text-amber-400' : 'text-slate-200'); ?> text-base leading-none">★</span>
                                                        <?php endfor; ?>
                                                    </div>
                                        ...
                                        <td class="px-4 py-3 text-slate-700 border-r border-slate-100 font-medium"><?php echo e($row->responsabilidad); ?></td>
                                        <td class="px-4 py-3 text-slate-600 border-r border-slate-100"><?php echo e($row->nombre); ?></td>
                                        <td class="px-4 py-3 border-r border-slate-100">
                                            <?php if($row->correo_electronico): ?>
                                                <a href="mailto:<?php echo e($row->correo_electronico); ?>"
                                                   class="text-blue-600 hover:underline text-xs"><?php echo e($row->correo_electronico); ?></a>
                                            <?php endif; ?>
                                        </td>
                                        <td class="px-4 py-3 text-slate-600 border-r border-slate-100 font-mono text-xs"><?php echo e($row->telefono); ?></td>
                                        <td class="px-4 py-3 text-slate-500 border-r border-slate-100 text-xs max-w-[200px] whitespace-pre-line"><?php echo e($row->comentarios); ?></td>
                                        <td class="px-4 py-3 text-center">
                                            <div class="flex items-center justify-center gap-1">
                                                <button data-id="<?php echo e($row->id); ?>" data-record='<?php echo json_encode($row->toArray(), 15, 512) ?>' onclick="editarAgente(this)"
                                                ...
                                                <button data-id="<?php echo e($row->id); ?>" onclick="eliminarAgente(this.dataset.id)"
            ...
            <div class="bg-white rounded-b-2xl rounded-tr-2xl border border-slate-200 shadow-sm overflow-hidden">
                ...
                <div class="px-5 py-4 border-b border-slate-100 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
                    <div>
                        ...
                        <p class="text-xs text-slate-400 mt-0.5"><?php echo e($forwarders->count()); ?> registros</p>
                    </div>
                    <div class="flex gap-2 items-center flex-wrap">
                    ...
                    <table class="w-full text-sm border-collapse" id="tabla-forwarders">
                        ...
                        <tbody id="tbody-forwarders">
                            <?php
                                ...
                                $groupIdxFw   = 0;
                            ?>
                            <?php $__empty_1 = true; $__currentLoopData = $groupedFw; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $clienteName => $rows): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <?php $bgClass = $groupIdxFw % 2 === 0 ? 'bg-white' : 'bg-slate-50/60'; ?>
                                <?php $__currentLoopData = $rows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="<?php echo e($bgClass); ?> border-b border-slate-100 hover:bg-amber-50/40 transition-colors fw-row"
                                        data-grupo="<?php echo e($groupIdxFw); ?>"
                                        data-cliente="<?php echo e(mb_strtolower($row->cliente ?? '')); ?>"
                                        data-propio="<?php echo e(in_array(mb_strtolower($row->cliente ?? ''), $misClientes) ? '1' : '0'); ?>"
                                        data-search="<?php echo e(mb_strtolower($row->cliente . ' ' . $row->aduana . ' ' . $row->razon_social . ' ' . $row->responsabilidad . ' ' . $row->nombre . ' ' . $row->correo_electronico . ' ' . $row->telefono . ' ' . $row->comentarios)); ?>">
                                        ...
                                        <td class="px-4 py-3 border-r border-slate-100">
                                            <?php if($row->correo_electronico): ?>
                                                <a href="mailto:<?php echo e($row->correo_electronico); ?>" class="text-blue-600 hover:underline text-xs"><?php echo e($row->correo_electronico); ?></a>
                                            <?php endif; ?>
                                        </td>
                                        <td class="px-4 py-3 text-slate-600 border-r border-slate-100 font-mono text-xs"><?php echo e($row->telefono); ?></td>
                                        <td class="px-4 py-3 text-slate-500 border-r border-slate-100 text-xs max-w-[200px] whitespace-pre-line"><?php echo e($row->comentarios); ?></td>
                                        <td class="px-4 py-3 text-center">
                                            <div class="flex items-center justify-center gap-1">
                                                <button data-id="<?php echo e($row->id); ?>" data-record='<?php echo json_encode($row->toArray(), 15, 512) ?>' onclick="editarForwarder(this)"
                                                        class="p-1.5 text-slate-400 hover:text-amber-600 hover:bg-amber-50 rounded-lg transition" title="Editar">
                                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/>
                                                    </svg>
                                                </button>
                                                <button data-id="<?php echo e($row->id); ?>" onclick="eliminarForwarder(this.dataset.id)"
                                                        class="p-1.5 text-slate-400 hover:text-red-600 hover:bg-red-50 rounded-lg transition" title="Eliminar">
                                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"/>
                                                    </svg>
            ...
            <div class="bg-white rounded-b-2xl rounded-tr-2xl border border-slate-200 shadow-sm overflow-hidden">
                <div class="px-5 py-4 border-b border-slate-100 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
                    <div>
                        ...
                        <p class="text-xs text-slate-400 mt-0.5"><?php echo e($navieras->count()); ?> registros</p>
                    </div>
                    <div class="flex gap-2 items-center flex-wrap">
                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-sm border-collapse">
                        ...
                        <tbody id="tbody-navieras">
                            <?php $groupedNv = $navieras->groupBy(fn($r) => ($r->cliente ?? '') . '||' . ($r->razon_social ?? '')); $gIdxNv = 0; ?>
                            <?php $__empty_1 = true; $__currentLoopData = $groupedNv; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gk => $rows): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <?php $bgClass = $gIdxNv % 2 === 0 ? 'bg-white' : 'bg-slate-50/60'; ?>
                                <?php $__currentLoopData = $rows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="<?php echo e($bgClass); ?> border-b border-slate-100 hover:bg-amber-50/40 transition-colors nv-row"
                                        data-grupo="<?php echo e($gIdxNv); ?>"
                                        data-cliente="<?php echo e(mb_strtolower($row->cliente ?? '')); ?>"
                                        data-propio="<?php echo e(in_array(mb_strtolower($row->cliente ?? ''), $misClientes) ? '1' : '0'); ?>"
                                        data-search="<?php echo e(mb_strtolower($row->cliente . ' ' . $row->aduana . ' ' . $row->razon_social . ' ' . $row->responsabilidad . ' ' . $row->nombre . ' ' . $row->correo_electronico . ' ' . $row->comentarios)); ?>">
                                        <?php if($i === 0): ?>
                                            <td rowspan="<?php echo e($rows->count()); ?>" class="px-4 py-3 font-semibold text-slate-800 align-top border-r border-slate-100 border-b border-slate-200"><?php echo e($row->cliente); ?></td>
                                            <td rowspan="<?php echo e($rows->count()); ?>" class="px-4 py-3 text-slate-600 align-top border-r border-slate-100 border-b border-slate-200"><?php echo e($row->aduana); ?></td>
                                            <td rowspan="<?php echo e($rows->count()); ?>" class="px-4 py-3 text-slate-600 align-top border-r border-slate-100 border-b border-slate-200"><?php echo e($row->razon_social); ?></td>
                                            <td rowspan="<?php echo e($rows->count()); ?>" class="px-4 py-3 align-top border-r border-slate-100 border-b border-slate-200 text-center">
                                                <?php if($row->calificacion): ?>
                                                    <div class="flex justify-center gap-0.5 mb-0.5"><?php for($s=1;$s<=5;$s++): ?><span class="<?php echo e($s<=$row->calificacion?'text-amber-400':'text-slate-200'); ?> text-base">★</span><?php endfor; ?></div>
                                                    <span class="text-xs text-slate-400"><?php echo e($row->calificacion); ?>/5</span>
                                        ...
                                        <td class="px-4 py-3 text-slate-700 border-r border-slate-100 font-medium"><?php echo e($row->responsabilidad); ?></td>
                                        <td class="px-4 py-3 text-slate-600 border-r border-slate-100"><?php echo e($row->nombre); ?></td>
                                        <td class="px-4 py-3 border-r border-slate-100"><?php if($row->correo_electronico): ?><a href="mailto:<?php echo e($row->correo_electronico); ?>" class="text-blue-600 hover:underline text-xs"><?php echo e($row->correo_electronico); ?></a><?php endif; ?></td>
                                        <td class="px-4 py-3 text-slate-600 border-r border-slate-100 font-mono text-xs"><?php echo e($row->telefono); ?></td>
                                        <td class="px-4 py-3 text-slate-500 border-r border-slate-100 text-xs max-w-[200px]"><?php echo e($row->comentarios); ?></td>
                                        <td class="px-4 py-3 text-center">
                                            <div class="flex items-center justify-center gap-1">
                                                <button data-id="<?php echo e($row->id); ?>" data-record='<?php echo json_encode($row->toArray(), 15, 512) ?>' onclick="editarNaviera(this)" class="p-1.5 text-slate-400 hover:text-amber-600 hover:bg-amber-50 rounded-lg transition" title="Editar">
                                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/></svg>
                                                </button>
                                                <button data-id="<?php echo e($row->id); ?>" onclick="eliminarNaviera(this.dataset.id)" class="p-1.5 text-slate-400 hover:text-red-600 hover:bg-red-50 rounded-lg transition" title="Eliminar">
            ...
            <div class="bg-white rounded-b-2xl rounded-tr-2xl border border-slate-200 shadow-sm overflow-hidden">
                <div class="px-5 py-4 border-b border-slate-100 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
                    <div>
                        ...
                        <p class="text-xs text-slate-400 mt-0.5"><?php echo e($arrastres->count()); ?> registros</p>
                    </div>
                    <div class="flex gap-2 items-center flex-wrap">
                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-sm border-collapse">
                        ...
                        <tbody id="tbody-arrastres">
                            <?php $groupedAr = $arrastres->groupBy(fn($r) => ($r->cliente ?? '') . '||' . ($r->razon_social ?? '')); $gIdxAr = 0; ?>
                            <?php $__empty_1 = true; $__currentLoopData = $groupedAr; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gk => $rows): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <?php $bgClass = $gIdxAr % 2 === 0 ? 'bg-white' : 'bg-slate-50/60'; ?>
                                <?php $__currentLoopData = $rows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="<?php echo e($bgClass); ?> border-b border-slate-100 hover:bg-amber-50/40 transition-colors ar-row"
                                        data-grupo="<?php echo e($gIdxAr); ?>"
                                        data-cliente="<?php echo e(mb_strtolower($row->cliente ?? '')); ?>"
                                        data-propio="<?php echo e(in_array(mb_strtolower($row->cliente ?? ''), $misClientes) ? '1' : '0'); ?>"
                                        data-search="<?php echo e(mb_strtolower($row->cliente . ' ' . $row->aduana . ' ' . $row->razon_social . ' ' . $row->responsabilidad . ' ' . $row->nombre . ' ' . $row->correo_electronico . ' ' . $row->comentarios)); ?>">
                                        <?php if($i === 0): ?>
                                        ...
                                        <td class="px-4 py-3 text-center">
                                            <div class="flex items-center justify-center gap-1">
                                                <button data-id="<?php echo e($row->id); ?>" data-record='<?php echo json_encode($row->toArray(), 15, 512) ?>' onclick="editarArrastre(this)" class="p-1.5 text-slate-400 hover:text-amber-600 hover:bg-amber-50 rounded-lg transition" title="Editar">
                                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/></svg>
                                                </button>
                                                <button data-id="<?php echo e($row->id); ?>" onclick="eliminarArrastre(this.dataset.id)" class="p-1.5 text-slate-400 hover:text-red-600 hover:bg-red-50 rounded-lg transition" title="Eliminar">
                                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"/></svg>
                                                </button>
                                            </div>
                                        </td>
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <select id="f-cliente" class="w-full text-sm border border-slate-200 rounded-xl px-3 py-2.5 focus:outline-none focus:ring-2 focus:ring-amber-400 bg-white">
                        ...
                        <?php $__currentLoopData = $clientes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if(in_array(mb_strtolower($cl), $misClientes)): ?>
                ...
                <div>
                    ...
                    <select id="f-aduana" class="w-full text-sm border border-slate-200 rounded-xl px-3 py-2.5 focus:outline-none focus:ring-2 focus:ring-amber-400 bg-white">
                        ...
                        <?php $__currentLoopData = $aduanas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $a): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($a->aduana.$a->seccion); ?>"><?php echo e($a->aduana.$a->seccion); ?> - <?php echo e($a->denominacion); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
                ...
                <div>
                    ...
                    <select id="f-calificacion"
                        ...
                        <?php for($i = 1; $i <= 5; $i++): ?>
                            <option value="<?php echo e($i); ?>"><?php echo e($i); ?> — <?php echo e(str_repeat('★', $i)); ?><?php echo e(str_repeat('☆', 5 - $i)); ?></option>
                        <?php endfor; ?>
                    </select>
                </div>
                ...
                <div class="col-span-2">
                    ...
                    <select id="f-responsabilidad" required
                        ...
                        <?php $__currentLoopData = $responsabilidades; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <div class="col-span-2">
                    ...
                    <select id="fw-responsabilidad" required
                            class="w-full text-sm border border-slate-200 rounded-xl px-3 py-2.5 focus:outline-none focus:ring-2 focus:ring-amber-400 bg-white">
                        <option value="">Seleccionar responsabilidad...</option>
                        <?php $__currentLoopData = $responsabilidadesForwarder; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($r); ?>"><?php echo e($r); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
...
<div id="modal-naviera" class="hidden fixed inset-0 z-50 flex items-center justify-center p-4">
    ...
    <div class="relative bg-white rounded-3xl shadow-2xl w-full max-w-2xl overflow-hidden">
        ...
        <form id="form-naviera" class="p-6 overflow-y-auto max-h-[80vh]" onsubmit="guardarNaviera(event)">
            ...
            <div class="grid grid-cols-2 gap-4">
                <div><label class="block text-xs font-bold text-slate-600 uppercase tracking-wide mb-1">Cliente</label><select id="nv-cliente" class="w-full text-sm border border-slate-200 rounded-xl px-3 py-2.5 focus:outline-none focus:ring-2 focus:ring-amber-400 bg-white"><option value="">— Sin cliente —</option><?php $__currentLoopData = $clientes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(in_array(mb_strtolower($cl),$misClientes)): ?><option value="<?php echo e($cl); ?>"><?php echo e($cl); ?></option><?php endif; ?> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?></select></div>
                <div><label class="block text-xs font-bold text-slate-600 uppercase tracking-wide mb-1">Aduana</label><select id="nv-aduana" class="w-full text-sm border border-slate-200 rounded-xl px-3 py-2.5 focus:outline-none focus:ring-2 focus:ring-amber-400 bg-white"><option value="">— Sin aduana —</option><?php $__currentLoopData = $aduanas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $a): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><option value="<?php echo e($a->aduana.$a->seccion); ?>"><?php echo e($a->aduana.$a->seccion); ?> - <?php echo e($a->denominacion); ?></option><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?></select></div>
                ...
                <div>
                    ...
                    <select id="nv-calificacion" class="w-full text-sm border border-slate-200 rounded-xl px-3 py-2.5 focus:outline-none focus:ring-2 focus:ring-amber-400 bg-white">
                        <option value="">Sin calificación</option>
                        <?php for($i=1;$i<=5;$i++): ?><option value="<?php echo e($i); ?>"><?php echo e($i); ?> — <?php echo e(str_repeat('★',$i)); ?><?php echo e(str_repeat('☆',5-$i)); ?></option><?php endfor; ?>
                    </select>
                </div>
                <div class="col-span-2">
                    <label class="block text-xs font-bold text-slate-600 uppercase tracking-wide mb-1">Responsabilidad en la Operación <span class="text-red-500">*</span></label>
                    <select id="nv-responsabilidad" required class="w-full text-sm border border-slate-200 rounded-xl px-3 py-2.5 focus:outline-none focus:ring-2 focus:ring-amber-400 bg-white">
                        ...
                        <?php $__currentLoopData = $responsabilidadesNaviera; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><option value="<?php echo e($r); ?>"><?php echo e($r); ?></option><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
...
<div id="modal-arrastre" class="hidden fixed inset-0 z-50 flex items-center justify-center p-4">
    ...
    <div class="relative bg-white rounded-3xl shadow-2xl w-full max-w-2xl overflow-hidden">
        ...
        <form id="form-arrastre" class="p-6 overflow-y-auto max-h-[80vh]" onsubmit="guardarArrastre(event)">
            ...
            <div class="grid grid-cols-2 gap-4">
                <div><label class="block text-xs font-bold text-slate-600 uppercase tracking-wide mb-1">Cliente</label><select id="ar-cliente" class="w-full text-sm border border-slate-200 rounded-xl px-3 py-2.5 focus:outline-none focus:ring-2 focus:ring-amber-400 bg-white"><option value="">— Sin cliente —</option><?php $__currentLoopData = $clientes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(in_array(mb_strtolower($cl),$misClientes)): ?><option value="<?php echo e($cl); ?>"><?php echo e($cl); ?></option><?php endif; ?> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?></select></div>
                <div><label class="block text-xs font-bold text-slate-600 uppercase tracking-wide mb-1">Aduana</label><select id="ar-aduana" class="w-full text-sm border border-slate-200 rounded-xl px-3 py-2.5 focus:outline-none focus:ring-2 focus:ring-amber-400 bg-white"><option value="">— Sin aduana —</option><?php $__currentLoopData = $aduanas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $a): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><option value="<?php echo e($a->aduana.$a->seccion); ?>"><?php echo e($a->aduana.$a->seccion); ?> - <?php echo e($a->denominacion); ?></option><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?></select></div>
                ...
                <div class="col-span-2">
                    ...
                    <select id="ar-responsabilidad" required class="w-full text-sm border border-slate-200 rounded-xl px-3 py-2.5 focus:outline-none focus:ring-2 focus:ring-amber-400 bg-white">
                        <option value="">Seleccionar...</option>
                        <?php $__currentLoopData = $responsabilidadesArrastre; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><option value="<?php echo e($r); ?>"><?php echo e($r); ?></option><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
