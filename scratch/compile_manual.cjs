...
(async () => {
    console.log('Iniciando compilación de PDF...');
    ...
    // Plantilla HTML Completa con Estilos CSS Premium
    const fullHtml = `
<!DOCTYPE html>
<html lang="es">
<head>
    <meta charset="UTF-8">
    <base href="${baseHref}">
    <title>Manual de Usuario — ERP Corporativo E&I</title>
...
<body>
    ...
    <!-- Portada -->
    <div class="cover">
        <img class="logo-img" src="file:///${path.join(__dirname, '../public/images/logo-ei.png').replace(/\\/g, '/')}" alt="Logo E&I">
        <div class="cover-title">Manual de Usuario</div>
        <div class="cover-subtitle">ERP Corporativo Estrategia e Innovación</div>
    ...
    await page.pdf({
        ...
        headerTemplate: '<div style="font-size: 8px; font-family: sans-serif; width: 100%; text-align: right; padding-right: 20px; color: #94a3b8;">Manual de Usuario ERP E&I</div>',
