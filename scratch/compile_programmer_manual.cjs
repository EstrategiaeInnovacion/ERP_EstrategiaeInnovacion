...
<head>
    <meta charset="UTF-8">
    <base href="${baseHref}">
    <title>Manual de Programador — ERP Corporativo E&I</title>
...
<body>
    ...
    await page.pdf({
        ...
        headerTemplate: '<div style="font-size: 8px; font-family: sans-serif; width: 100%; text-align: right; padding-right: 20px; color: #94a3b8;">Manual de Programador ERP E&I</div>',
