...
class PerfilClienteController extends Controller
{
    ...
    public function upsert(Request $request, Cliente $cliente)
    {
        $data = $request->validate([
            ...
            'registro_marca'                  => 'nullable|boolean',
            'poliza_seguro_mercancias'        => 'nullable|boolean',
            ...
            'tiene_immex_servicios'           => 'nullable|boolean',
            'immex_servicios_fecha'           => 'nullable|date',
            ...
            'nom_tipo'                        => 'nullable|string|max:255',
            ...
            'importa_fuera_tlcan_paises'      => 'nullable|string|max:255',
