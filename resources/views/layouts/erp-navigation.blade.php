                ...
                @auth
                    ...
                    <x-dropdown align="right" width="48">
                        ...
                        <x-slot name="content">
                            ...
                            @if((Auth::user()->empleado && Auth::user()->empleado->subordinados()->exists()) || Auth::user()->isRh())
                            <x-dropdown-link :href="route('vacaciones.aprobaciones')" class="group flex items-center">
                                <svg class="mr-2 h-4 w-4 text-slate-400 group-hover:text-indigo-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                                {{ __('Aprobaciones') }}
                            </x-dropdown-link>
                            @endif
