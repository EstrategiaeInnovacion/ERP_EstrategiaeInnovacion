        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            <div class="flex flex-col md:flex-row justify-between items-center gap-4">
                <div>
                    ...
                    <h1 class="text-3xl font-bold text-slate-900 tracking-tight">Anexo 24</h1>
                    <p class="text-slate-500 mt-1">Gestión de inventarios y control de Anexo 24.</p>
                </div>
