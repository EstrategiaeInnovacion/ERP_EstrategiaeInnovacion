                ...
                <div class="mb-10">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        ...
                        <a href="{{ route('activities.index') }}" class="group relative bg-white p-6 rounded-2xl shadow-sm border border-slate-200 hover:shadow-lg hover:border-indigo-200 transition-all duration-300 flex items-start gap-5 overflow-hidden">
                            ...
                            <div class="relative z-10 flex-1">
                                ...
                                <div class="mt-4 flex items-center text-xs font-bold text-indigo-600 uppercase tracking-wide">
                                    Ingresar al Módulo <span class="sr-only">de Reporte de Actividades</span><span aria-hidden="true" class="ml-2 group-hover:translate-x-1 transition-transform">→</span>
                                </div>
                            </div>
                        </a>
                        ...
                        <a href="{{ route('rh.evaluacion.index') }}" class="group relative bg-white p-6 rounded-2xl shadow-sm border border-slate-200 hover:shadow-lg hover:border-emerald-200 transition-all duration-300 flex items-start gap-5 overflow-hidden">
                            <div class="absolute right-0 top-0 p-4 opacity-5 group-hover:opacity-10 transition-opacity">
                                <svg aria-hidden="true" class="w-40 h-40 text-emerald-600" fill="currentColor" viewBox="0 0 24 24"><path d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"/></svg>
                            </div>
                            ...
                            <div class="relative z-10 flex-1">
                                <h3 class="text-xl font-bold text-slate-800 group-hover:text-emerald-700 transition-colors">Evaluación 180°</h3>
                                <p class="text-sm text-slate-500 mt-2 leading-relaxed">
                                ...
                                <div class="mt-4 flex items-center text-xs font-bold text-emerald-600 uppercase tracking-wide">
                                    Ingresar al Módulo <span class="sr-only">de Evaluación 180°</span><span aria-hidden="true" class="ml-2 group-hover:translate-x-1 transition-transform">→</span>
                                </div>
                            </div>
                        </a>
                        ...
                        <a href="{{ route('capacitacion.index') }}" class="group relative bg-white p-6 rounded-2xl shadow-sm border border-slate-200 hover:shadow-lg hover:border-violet-200 transition-all duration-300 flex items-start gap-5 overflow-hidden">
                            <div class="absolute right-0 top-0 p-4 opacity-5 group-hover:opacity-10 transition-opacity">
                                <svg aria-hidden="true" class="w-40 h-40 text-violet-600" fill="currentColor" viewBox="0 0 24 24"><path d="M4 6a2 2 0 012-2h12a2 2 0 012 2v12a2 2 0 01-2 2H6a2 2 0 01-2-2V6zm10.75 6.75l-4.5 2.6a.75.75 0 01-1.125-.65v-5.2a.75.75 0 011.125-.65l4.5 2.6a.75.75 0 010 1.3z" /></svg>
                            </div>
                            ...
                            <div class="relative z-10 flex-1">
                                ...
                                <div class="mt-4 flex items-center text-xs font-bold text-violet-600 uppercase tracking-wide">
                                    Ver Videos <span class="sr-only">de Centro de Capacitación</span><span aria-hidden="true" class="ml-2 group-hover:translate-x-1 transition-transform">→</span>
                                </div>
                            </div>
                        </a>
                        ...
                        @foreach($services as $srv)
                            <a href="{{ $srv['route'] }}" class="bg-white p-5 rounded-xl border border-slate-100 shadow-sm hover:shadow-md hover:border-{{ $srv['color'] }}-200 transition-all group flex flex-col h-full">
                                ...
                                <div class="text-[10px] font-bold text-{{ $srv['color'] }}-600 uppercase tracking-wider flex items-center">
                                    Crear Ticket <span class="sr-only">de {{ $srv['title'] }}</span><span aria-hidden="true" class="ml-1 opacity-0 group-hover:opacity-100 transition-opacity">→</span>
                                </div>
                            </a>
                        @endforeach
                    </div>
