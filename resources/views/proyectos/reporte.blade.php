    ...
    <div class="bg-white rounded-xl shadow-sm border border-slate-200 mb-6 overflow-hidden">
        <div class="bg-gradient-to-r from-indigo-600 via-indigo-700 to-indigo-800 px-8 py-6">
            <div class="flex justify-between items-center">
                ...
                <div class="no-print">
                    <a href="{{ route('proyectos.reporte.pdf', $proyecto->id) }}" class="bg-white text-indigo-600 px-5 py-2.5 rounded-lg font-bold text-sm hover:bg-indigo-50 transition shadow-lg flex items-center gap-2">
