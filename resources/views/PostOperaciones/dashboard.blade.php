...
@section('title', 'Panel Post-Operaciones')
...
<div class="min-h-screen bg-slate-50 pb-12">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            <div class="flex flex-col md:flex-row justify-between items-center gap-4">
                <div>
                    ...
                    <h1 class="text-3xl font-bold text-slate-900 tracking-tight">Post-Operaciones</h1>
                    <p class="text-slate-500 mt-1">Seguimiento y gestión de post-operaciones de comercio exterior.</p>
                </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            {{-- CARD: CLIENTES --}}
            <a href="{{ route('postoperaciones.clientes') }}"
               class="group bg-white p-6 rounded-3xl shadow-sm border border-slate-200 flex flex-col justify-between hover:shadow-md hover:border-indigo-200 transition-all duration-300">
                ...
                <div class="mt-auto pt-4 border-t border-slate-100">
                    <span class="group flex items-center justify-center w-full px-4 py-3 bg-sky-600 hover:bg-sky-700 text-white font-bold text-sm rounded-xl transition-all shadow-lg shadow-sky-200 hover:-translate-y-0.5">
