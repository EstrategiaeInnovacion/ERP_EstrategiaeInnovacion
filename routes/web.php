...
Route::middleware(['auth', 'area.rh'])->group(function () {
    ...
    Route::prefix('recursos-humanos/inventario')->name('rh.inventario.')->group(function () {
        ...
        Route::get('/exportar-excel', [ActivosController::class, 'exportExcel'])->name('exportar-excel'); // ← ANTES de /{uuid}
...
Route::middleware(['auth', 'verified', 'area.auditoria'])->prefix('auditoria')->name('auditoria.')->group(function () {
    ...
    Route::put('/proyectos/{id}/comentarios/{comentarioId}', [AuditoriaCambiosController::class, 'updateComentario'])->name('proyectos.comentarios.update');
    Route::delete('/proyectos/{id}/comentarios/{comentarioId}', [AuditoriaCambiosController::class, 'destroyComentario'])->name('proyectos.comentarios.destroy');
